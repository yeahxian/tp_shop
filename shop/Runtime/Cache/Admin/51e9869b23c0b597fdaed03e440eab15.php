...
<html>
    ...
    <body>
        ...
        <div class="div_head">
            <span>
                ...
                <span style="float: right; margin-right: 8px; font-weight: bold;">
                    <a style="text-decoration: none;" href="/index.php?m=Admin&c=Goods&a=add">【添加商品】</a>
                </span>
            </span>
        </div>
        <div></div>
        <div class="div_search">
            <span>
                <form action="/index.php/Admin/Goods/goodsList" method="get">
            ...
            <table class="table_a" border="1" width="100%">
                <tbody><tr style="font-weight: bold;">
                        ...
                        <?php if(is_array($goods_info)): $i = 0; $__LIST__ = $goods_info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><tr id="product1">
                                ...
                                <td><a href="/index.php?m=Admin&c=Goods&a=update&goods_id=<?php echo ($item["goods_id"]); ?>">修改</a></td>
                ...
                <!-- -->
                    <!--<tr id="product2">-->
                        ...
                        <!--<td><a href="/index.php/Admin/Category/update">修改</a></td>-->
