        ...
        <div class="div_head">
            <span>
                ...
                <span style="float: right; margin-right: 8px; font-weight: bold;">
                    <a style="text-decoration: none;" href="/index.php/Admin/Index/add">【添加商品】</a>
                </span>
            </span>
        </div>
        <div></div>
            ...
            <table class="table_a" border="1" width="100%">
                <tbody><tr style="font-weight: bold;">
                    ...
                    <tr id="product1">
                        ...
                        <td>100</td>
                        <td>3888</td>
                        <td><img src="/Public/Admin/img/20121018-174034-58977.jpg" height="60" width="60"></td>
                        <td><img src="/Public/Admin/img/20121018-174034-97960.jpg" height="40" width="40"></td>
                        <td>苹果apple</td>
                        <td>2012-10-18 17:40:34</td>
                        <td><a href="/index.php/Admin/Index/update">修改</a></td>
