            ...
            <form action="/Admin/User/login" method="post">
                <ul>
                        ...
                        <div class="user_main_box">
                            ...
                            <ul>
                                ...
                                <li class="user_main_input">
                                    ...
                                    <img src="/index.php?m=Admin&c=User&a=verify" alt=""/>
                                </li>
                            </ul>
                        </div>
                    </li>
                    <li class="user_main_r">
                        ...
                        <input style="border: medium none; background: url('/Public/Admin/images/user_botton.gif') repeat-x scroll left top transparent; height: 122px; width: 111px; display: block; cursor: pointer;"
                               value="" type="submit">
                    </li>
                </ul>
            </form>
