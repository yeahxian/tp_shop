        ...
        <div class="div_head">
            <span>
                ...
                <span style="float:right;margin-right: 8px;font-weight: bold">
                    <a style="text-decoration: none" href="/index.php/Admin/Category/showList">【返回】</a>
                </span>
            </span>
        </div>
        <div></div>
                ...
                <tr>
                    ...
                    <td>
                        <select name="goods_brand_id">
                            <option>请选择</option>
                            <?php if(is_array($brand_info)): $i = 0; $__LIST__ = $brand_info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$brand): $mod = ($i % 2 );++$i;?><option value="<?php echo ($brand["id"]); ?>" <?php echo ($brand['id']==$goods_info['goods_brand_id']?'selected':''); ?> ><?php echo (str_repeat("--",$brand["level"])); echo ($brand["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                        </select>
                    </td>
                </tr>
                <tr>
