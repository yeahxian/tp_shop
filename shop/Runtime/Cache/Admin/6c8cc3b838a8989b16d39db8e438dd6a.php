...
<div class="div_head">
            <span>
                ...
                <span style="float:right;margin-right: 8px;font-weight: bold">
                    <a style="text-decoration: none" href="/index.php/Admin/Category/add">【添加分类】</a>
                </span>
            </span>
</div>
<div></div>
    ...
    <div style="font-size: 13px; margin: 10px 5px;">
        <table class="table_a" border="1" width="100%">
            ...
            <?php if(is_array($category_info)): $i = 0; $__LIST__ = $category_info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$category): $mod = ($i % 2 );++$i;?><tr id="product1">
                    ...
                    <td><a href="/index.php?m=Admin&c=Category&a=updateCategories&cat_id=<?php echo ($category["cat_id"]); ?>">修改</a></td>
                    <td><a href="javascript:;" onclick="delete_product(<?php echo ($category["cat_id"]); ?>)">删除</a></td>
