...
<!--<html xmlns="http://www.w3.org/1999/xhtml">-->
    ...
    <!--<body>-->
        <!--<div class="block clearfix" style="position: relative; height: 98px;">-->
            <!--<a href="#" name="top">-->
                <!--<img class="logo" src="<?php echo (DEFAULT_IMAGES); ?>/logo.gif">-->
            <!--</a>-->
            ...
            <div class="usBox clearfix">
                ...
                <div class="usTxt">
                    ...
                    <div style="padding-left: 50px;">
                        ...
                        3. 享受会员积分制度<br />
                        4. 订阅本店商品信息  <br />
                        <a href="#"><img src="<?php echo (DEFAULT_IMAGES); ?>/bnt_ur_reg.gif"></a>
                    </div>
                </div>
            </div>
            </div>
            ...
            <div id="bottomNav" class="box block">
                <div class="box_1">
                    <div class="links clearfix"> 
                        <a href="#" target="_blank" title="YONGDA商城"><img src="<?php echo (DEFAULT_IMAGES); ?>/logo.gif" alt="YONGDA商城" border="0"></a>
