...
<!--<body class="index_body">-->
<!--<div class="block clearfix" style="position: relative; height: 98px;">-->
    <!--<a href="#" name="top"><img class="logo" src="<?php echo (DEFAULT_IMAGES); ?>/logo.gif"></a>-->
    ...
    <div class="block box">
        ...
        <div class="usBox">
            <div class="usBox_2 clearfix">
                ...
                <form id="yw0" action="/index.php?m=Home&c=User&a=register" method="post">
                    <table cellpadding="5" cellspacing="3" style="text-align:left; width:100%; border:0;">
                        ...
                        <tr>
                            ...
                            <td>
                                <input class="inputBg" size="25" name="repassword" id="User_password2" type="password"/>
                            </td>
...
<div id="bottomNav" class="box block">
    <div class="box_1">
        <div class="links clearfix">
            <a href="#" target="_blank" title="YONGDA商城"><img src="<?php echo (DEFAULT_IMAGES); ?>/ecmoban_link.jpg"
                                                              alt="YONGDA商城" border="0"></a>

            <a href="#" target="_blank" title="YONGDA 网上商店管理系统">
                <img src="<?php echo (DEFAULT_IMAGES); ?>/yongda_logo.gif" alt="YONGDA 网上商店管理系统" border="0"/>
            </a>
