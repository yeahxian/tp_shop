...
<head>
    ...
    <script src="<?php echo (DEFAULT_JS); ?>/user.js"></script>
</head>
...
<div class="block clearfix" style="position: relative; height: 98px;">
    ...
    <div id="topNav" class="clearfix">
        ...
        <div style="float: right;">
            <a href="/Home/Goods/cart">查看购物车</a>
            |
            <a href="#">选购中心</a>
            |
            <a href="#">标签云</a>
...
<div class="header_bg">
    ...
    <form id="searchForm" method="get" action="#">
        ...
        <input name="imageField" value=" " class="go"
               style="cursor: pointer; background: url('<?php echo (DEFAULT_IMAGES); ?>/sousuo.gif') no-repeat scroll 0% 0% transparent; width: 39px; height: 20px; border: medium none; float: left; margin-right: 15px; vertical-align: middle;"
               type="submit"/>
    ...
    <div class="block clearfix">
            ...
            <div class="box">
                ...
                <div class="box_1">
                    <div class="top10List clearfix">
                        <ul class="clearfix">
                            <img src="<?php echo (DEFAULT_IMAGES); ?>/top_1.gif" class="iteration">
                            <li class="topimg">
                                <a href="#"><img src="<?php echo (DEFAULT_IMAGES); ?>/3_thumb_G_1241422082679.jpg" alt=""
                                                 class="samllimg"></a>
                            </li>
                        ...
                        <ul class="clearfix">
                            <img src="<?php echo (DEFAULT_IMAGES); ?>/top_2.gif" class="iteration">
                            <li class="topimg">
                                <a href="#"><img src="<?php echo (DEFAULT_IMAGES); ?>/24_thumb_G_1241971981429.jpg" alt=""
                                                 class="samllimg"></a>
                            </li>
                        ...
                        <ul class="clearfix">
                            <img src="<?php echo (DEFAULT_IMAGES); ?>/top_3.gif" class="iteration">
                            <li class="topimg">
                                <a href="#"><img src="<?php echo (DEFAULT_IMAGES); ?>/12_thumb_G_1241965978410.jpg" alt=""
                                                 class="samllimg"></a>
                            </li>
                        ...
                        <ul class="clearfix">
                            <img src="<?php echo (DEFAULT_IMAGES); ?>/top_4.gif" class="iteration">
                        ...
                        <ul class="clearfix">
                            <img src="<?php echo (DEFAULT_IMAGES); ?>/top_5.gif" class="iteration">
                        ...
                        <ul class="clearfix">
                            <img src="<?php echo (DEFAULT_IMAGES); ?>/top_6.gif" class="iteration">
                        ...
                        <ul class="clearfix">
                            <img src="<?php echo (DEFAULT_IMAGES); ?>/top_7.gif" class="iteration">
            ...
            <div class="box"><h3><span>品牌专区</span></h3>
                <div class="box_1">
                    <div class=" brands clearfix">
                        <a href="#"><img src="<?php echo (DEFAULT_IMAGES); ?>/1240803062307572427.gif" alt="诺基亚 (7)"></a>
                        <a href="#"><img src="<?php echo (DEFAULT_IMAGES); ?>/1240802922410634065.gif" alt="摩托罗拉 (1)"></a>
                        <a href="#"><img src="<?php echo (DEFAULT_IMAGES); ?>/1240803144788047486.gif" alt="多普达 (1)"></a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="AreaM">
            <div class="box clearfix">
                <div id="focus">
                    <img src="<?php echo (DEFAULT_IMAGES); ?>/111.jpg" width="515" height="160" alt=""/>
                </div>
            </div>
            <div class="blank"></div>
            ...
            <div id="show_hot_area" class="clearfix">
                <div class="goodsItem">
                    ...
                    <a href="#"><img src="<?php echo (DEFAULT_IMAGES); ?>/9_thumb_G_1241511871555.jpg" alt="诺基亚E66"
                                     class="goodsimg"></a><br/>
                ...
                <div class="goodsItem">
                    ...
                    <a href="#"><img src="<?php echo (DEFAULT_IMAGES); ?>/1_thumb_G_1240902890710.jpg" alt="KD876"
                                     class="goodsimg"></a><br/>
                ...
                <div class="goodsItem">
                    ...
                    <a href="#"><img src="<?php echo (DEFAULT_IMAGES); ?>/8_thumb_G_1241425513488.jpg" alt="飞利浦9@9v"
                                     class="goodsimg"></a><br/>
